...
<!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content -->
					...
					<div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class=""></i>Data Neraca Awal<br><small>Kelola Data Neraca Awal</small>
						...
						<ul class="breadcrumb breadcrumb-top">
						 ...
						 <div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Tabel</strong> Neraca Awal</h2>
							...
							<div class="table-responsive">
                            	<a href="data_neraca_awal_form_tambah.php" class="btn btn-primary">+ Neraca Awal</a>
							<br>
							<br>
                            ...
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
								...
								$sql = "SELECT * FROM neracaawal WHERE tgl LIKE '$tgl%%' ORDER BY tgl DESC";
								...
								?>
									<tr>
                                        ...
                                        <td class="text-center"><?php echo $row['kredit'];?></td>
										...
										<td class="text-center">
											...
											<a href="data_neraca_awal_delete.php?kode=<?php echo $row["id"]; ?>" title="Delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</i></a>
                                        </td>
                                    </tr>
								<?php
								$no++;
