					...
					<div class="content-header">
                        ...
                        <div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Edit Profil</strong> Admin</h2>
                            </div>
							...
							<div id="edit" tabindex="-1" role="dialog" aria-hidden="true">
								...
								if($result) {
									while ($row = mysqli_fetch_row($result)){
										...
										$nama = $row[2];
								?>
							<form action="admin_profil_proses.php" method="post" class="form-horizontal form-bordered">

						<div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Username</label>
                                            <div class="col-md-9">
                                                <input type="text" id="username" name="username" class="form-control" placeholder="Masukkan Username" value="<?php echo $username; ?>" readonly="yes"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="password" id="password" name="password" class="form-control" placeholder="Masukkan Password" value="<?php echo $password; ?>" required="yes">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?php echo $nama; ?>" required="yes">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>                            
                                                </div>
