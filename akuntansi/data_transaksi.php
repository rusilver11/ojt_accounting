						...
						<ul class="breadcrumb breadcrumb-top">
						 ...
						 <div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Tabel</strong> Transaksi</h2>
                            </div>
							
							<div class="table-responsive">
                            	<a href="data_transaksi_form_tambah.php" class="btn btn-primary">+ Transaksi</a>
							<br>
							<br>
                            ...
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                <tbody>
								<?php
								$sql = "SELECT * FROM transaksi WHERE jurnal = 'umum' ORDER BY tgl DESC";
								...
								?>
									<tr>
                                        ...
                                        <td class="text-center"><?php echo $debet;?></td>
                                        <td class="text-center"><?php echo $kredit;?></td>
										<td class="text-center">
                                            <!--<a data-href="data_transaksi_edit_data.php?nobukti=<?php echo $row["nobukti"]; ?>" href="#edit" data-toggle="modal" title="Edit"  class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</i></a>-->	
											<a href="data_transaksi_delete.php?nobukti=<?php echo base64_encode($row["nobukti"]); ?>" onclick="return confirm('Yakin akan Hapus')" title="Delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</i></a>
                                        </td>
                                    </tr>
								<?php
								$no++;
