						...
						<ul class="breadcrumb breadcrumb-top">
						  ...
						  <div class="block full">
							...
							<div id="edit" tabindex="-1" role="dialog" aria-hidden="true">
								...
								*/
								?>
							<form action="data_proses_kios_tambah.php" method="post" class="form-horizontal form-bordered">

						              <h4><strong>Tambah Data Kios</strong></h4>
                                     
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input" style="text-align:left;">Kode Kios</label>
                                            <div class="col-md-9">
                                                <input type="text" id="kodekios" name="kodekios" class="form-control" placeholder="Masukan Kode Kios">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="namakios" name="namakios" class="form-control" placeholder="Masukan Nama Kios">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input" style="text-align:left;">Alama Kios</label>
                                            <div class="col-md-9">
                                                <input type="text" id="alamatkios" name="alamatkios" class="form-control" placeholder="Masukan Alamat Kios">
                                                <span class="help-block"></span>
                                            </div>
