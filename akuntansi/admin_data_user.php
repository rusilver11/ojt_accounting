			...
			$(document).ready(function(){
				...
				$("#submit").click(function(){
					...
					else
					{
						...
						$.ajax({
						type: "POST",
						url: "admin_data_user_tambah.php",
						data: dataString,
						cache: false,
						success: function(result){
				...
				$("#update").click(function(){
					...
					else
					{
						...
						$.ajax({
						type: "POST",
						url: "admin_data_user_edit_proses.php",
						data: dataString,
						cache: false,
						success: function(result){
							window.location=(window.location);
...
<!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content -->
					...
					<div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class=""></i>Data User<br><small>Kelola Data User</small>
								<!--	<br>
									<br>
						...
						<div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Tabel</strong> User</h2>
                            </div>
                            <!-- END All Products Title -->

							
							<div class="table-responsive">
                            	<a href="#tambah" class="btn btn-primary" data-toggle="modal">Tambah Data User</a>
							<br>
							<br>
								...
								?>
									<tr>
										...
										<td class="text-center">
                                            <a data-href="admin_data_user_edit_data.php?username=<?php echo base64_encode($row["username"]); ?>" href="#edit" data-toggle="modal" title="Edit"  class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</i></a>	
											<a href="admin_data_user_delete.php?username=<?php echo $row["username"]; ?>" title="Delete" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i> Delete</i></a>
                                        </td>
                                    </tr>
								<?php
								$no++;
