    ...
    <body>
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><strong>AKUNTASI SEKTOR PUBLIK</strong><br>
				<small>Please Login</small></h1>
            </div>
            <!-- END Login Title -->
					...
					<?php
					  if (isset($_POST["submit"])) {
                        ...
                        elseif{
                                      ...
                                      $login1 = mysqli_query($connect, "SELECT * FROM user WHERE username =
                                      '$username' AND password='$pass'");
                                      $row2=mysqli_fetch_array($login1);
									  ...
									  $login2 = mysqli_query($connect, "SELECT * FROM mahasiswa WHERE username =
									  '$username' AND password='$pass'");
