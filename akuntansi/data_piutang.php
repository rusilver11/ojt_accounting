						...
						<ul class="breadcrumb breadcrumb-top">
						 ...
						 <div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Tabel</strong> Piutang</h2>
                            </div>
							
							<div class="table-responsive">
                            	<a href="data_piutang_form_tambah.php" class="btn btn-primary">+ Piutang</a>
							<br>
							<br>
                            ...
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $row['tglfaktur'];?></td>
                                        <td class="text-center"><?php echo $row['nofaktur'];?></td>
                                        <td class="text-center"><?php echo $row['kios'];?></td>
                                        <td class="text-center"><?php echo $row['ton'];?></td>
                                        <td class="text-center"><?php echo $row['totaluang'];?></td>
                                        <td class="text-center"><?php echo $row['piutang'];?></td>
                                        
                                        <td class="text-center"><?php echo $row['tunai'];?></td>
                                        <td class="text-center"><?php echo $row['tglbayar'];?></td>

                                        <td class="text-center"><?php echo $row['sisa'];?></td>
                                        <td class="text-center">
                                            <a href="data_piutang_form_edit.php?kode=<?php echo $row["idpiutang"]; ?>"  title="Edit"  class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</i></a>
                                            <a href="data_piutang_delete.php?kode=<?php echo $row["idpiutang"]; ?>" onclick="return confirm('Yakin akan Hapus')" title="Delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</i></a>
                                        </td>
                                    </tr>
                                <?php
