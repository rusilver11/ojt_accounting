...
<!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content --><!-- Page content -->
					...
					<div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class=""></i>Jurnal Penyesuaian<br><small>Lihat Jurnal Penyesuaian dan Cetak</small>
								<!--	<br>
									<br>
						...
						<ul class="breadcrumb breadcrumb-top">
						 ...
						 <div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Jurnal</strong> Penyesuaian</h2>
                            </div>
							...
							<div class="table-responsive">
                            	...
                            	<a href="export_PDF_ju.php?user=<?php echo base64_encode($_SESSION['username']);?>" title="Download" class="btn btn alert-danger">
								<i class="fa fa-download"></i> CETAK JURNAL PENYESUAIAN</i></a>
								<br>
							<br> 
                            ...
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    $sqlrowspan = "SELECT COUNT(nojp) as jumlah, tgl FROM jurnalpenyesuaian WHERE nojp = '".$row['nojp']."'";
                                ...
                                ?>
                                    ...
                                    <?php
                                    $sqlall = "SELECT * FROM jurnalpenyesuaian WHERE nojp = '".$row['nojp']."' ORDER by tgl ASC, nobukti";
