<?php
	...
	if($mod == "modul" AND $act == "simpan")
	{
		mysql_query("INSERT INTO modul(id_menu, nama_modul, link_menu, posisi, icon_menu)
									VALUES ('$_POST[id_menu]', '$_POST[nama_modul]', '$_POST[link_menu]', '$_POST[posisi]', '$_POST[icon_menu]')") ;
	...
	{
		mysql_query("UPDATE modul SET id_menu= '$_POST[id_menu]', nama_modul= '$_POST[nama_modul]', link_menu= '$_POST[link_menu]', posisi= '$_POST[posisi]', icon_menu= '$_POST[icon_menu]' WHERE id_modul = '$_POST[id]'");
