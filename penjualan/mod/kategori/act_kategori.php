<?php
	...
	if($mod == "kategori" AND $act == "simpan")
	{
		...
		mysqli_query($conn,"INSERT INTO tb_kategori_barang(kategori_id, 
										nama_kategori)
									VALUES ('$kategori_id', 
										'$nama_kategori')");
	...
	elseif ($mod == "kategori" AND $act == "edit") 
	{
		...
		mysqli_query($conn,"UPDATE tb_kategori_barang SET 
	...
	{
		mysqli_query($conn,"DELETE FROM tb_kategori_barang WHERE kategori_id = '$_GET[id]'");
