...
<head>
    ...
    <link rel="shortcut icon" href="images/logobar.png" />
...
<nav id="left-nav" class="w3-sidenav w3-small w3-light-grey w3-card-4" style="width:250px;">
  <div id="menuTut" class="myMenu w3-accordion">
    <?php
        $sql_menu = mysqli_query($conn,"SELECT * FROM tb_menu ORDER BY posisi ASC") or die(mysqli_error());
        while ($mn = mysqli_fetch_assoc($sql_menu)) {
            ...
            $sql_sub = mysqli_query($conn,"SELECT * FROM tb_modul 
                WHERE id_menu = '$mn[id_menu]' ORDER BY posisi ASC") or die(mysqli_error());
